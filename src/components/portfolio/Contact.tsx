...
const CONTACT_LINKS = [
  {
    label: "WhatsApp",
    description: { en: "Send me a message", id: "Kirim pesan langsung" },
    href:
  ...
  {
    label: "Email",
    description: { en: "Discuss a project", id: "Diskusikan proyek" },
    href:
  ...
  },
  {
    label: "Instagram",
    description: {
      en: "See my visual updates",
      id: "Lihat pembaruan visual",
    },
  ...
  },
  {
    ...
    description: {
      ...
      id: "Terhubung secara profesional",
    },
      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-6 md:px-10 lg:px-16">
        ...
        <div className="flex flex-col items-center py-12 text-center md:py-16">
          <p className="text-xs uppercase tracking-[0.3em] text-white/55">
            {copy({ en: "Get in touch", id: "Mari terhubung" })}
          </p>
          ...
          <h2 className="mt-6 max-w-3xl font-display text-4xl italic text-white md:text-6xl">
            {copy({
              ...
              id: "Mari membangun sesuatu yang layak diingat.",
            })}
          </h2>

          <p className="mt-5 max-w-xl text-sm leading-7 text-white/55 md:text-base">
            {copy({
              en: "Have a project, collaboration, or opportunity in mind? Reach me through any platform below.",
              id: "Punya proyek, kolaborasi, atau peluang yang ingin dibicarakan? Hubungi saya melalui platform di bawah ini.",
            })}
          </p>
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-6 border-t border-white/15 pt-8 text-sm md:flex-row">
          <div className="flex items-center gap-2 text-white/60">
            ...
            {copy({ en: "Available for projects", id: "Tersedia untuk proyek" })}
          </div>
          ...
          <div className="text-xs text-white/45">© 2026 Amanda Pricillia</div>
        </div>
      </div>
    </section>
  );
