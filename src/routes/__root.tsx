  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-bg px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted">Try refreshing or head back home.</p>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Amanda Pricillia — Creative Portfolio" },
      {
        name: "description",
        content:
          "Portfolio of Amanda Pricillia — designer and developer based in Tangerang. Selected works, explorations, and journal.",
      },
      { name: "author", content: "Amanda Pricillia" },
      { property: "og:title", content: "Amanda Pricillia — Creative Portfolio" },
      {
        property: "og:description",
        content: "Selected works, explorations, and journal from a Chicago-based creative.",
      },
